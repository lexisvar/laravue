...
<head>
    ...
    <link href="{{ asset('public/css/assets/global/plugins/uniform/css/uniform.default.css') }}" rel="stylesheet" type="text/css" >
    ...
    <link href="{{ asset('public/css/assets/global/css/components.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/css/assets/global/css/plugins.min.css') }}" rel="stylesheet" type="text/css" >

    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN THEME LAYOUT STYLES -->
    <link href="{{ asset('public/css/assets/global/layouts/layout/css/layout.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/css/assets/global/layouts/layout/css/themes/darkblue.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/css/assets/global/layouts/layout/css/custom.min.css') }}" rel="stylesheet" type="text/css" >
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                ...
                <img src="{{ asset('public/css/assets/global/layouts/layout/img/logo.png') }}" alt="logo" class="logo-default" />
            </a>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('public/css/assets/global/layouts/layout/img/avatar2.jpg') }}" alt="logo" class="logo-default" />
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('public/css/assets/global/layouts/layout/img/avatar3.jpg') }}" class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('public/css/assets/global/layouts/layout/img/avatar1.jpg') }}" class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('public/css/assets/global/layouts/layout/img/avatar2.jpg') }}" class="img-circle" alt=""> </span>
                                        <span class="subject">
                                                    <span class="from"> Lisa Wong </span>
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="{{ asset('public/css/assets/global/layouts/layout/img/avatar3_small.jpg') }}" />
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('public/css/assets/global/layouts/layout/img/avatar3.jpg') }}" alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{ asset('public/css/assets/global/layouts/layout/img/avatar1.jpg') }}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('public/css/assets/global/layouts/layout/img/avatar4.jpg') }}" alt="...">
                                <div class="media-body">
